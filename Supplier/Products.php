...
<div class="container-md cart">
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        <td> <a style="font-size: 1.6rem; color:#243a6f;"><?php echo $row['cat_name']?></a></td>
        <td>Rs.<?php echo $row['product_price']?>.00 </td>
        <td><p style="color: black;">Case : <?php echo $row['product_quantity']?></p></td>
            <td><a style="color: #00FA9A; font-size:1.8rem;" href='Add_Quantity.php?id=<?php echo $row["product_id"] ?>'>Add</a> 
            | <a style="font-size:1.8rem;" href='Delete_Products.php?id=<?php echo $row["product_id"] ?>'>Delete</a></td>
        </tr>
