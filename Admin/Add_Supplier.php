...
if(isset($_POST['submit'])){
      ...
      $sql = "INSERT INTO supplier (supplier_name, email, mobile_number, company, address, password)
      VALUES ('$supplier_name', '$email', '$mobile_number', '$company', '$address', '$password')";

      if (mysqli_query($conn, $sql)) {
        echo "<script>alert('New Supplier Account Added Successfully..')</script>";
...
<section id="content ">
    ...
    <div class="alert alert-success"><?php echo $message ?></div>
        ...
        ?>
        		<form method="post" enctype="multipart/form-data" action='Add_Supplier.php'>
			  <div class="form-group">
			    <label for="Suppliername">Supplier Name</label>
			    <input style="font-size:1.4rem;" type="text" class="form-control" name="supplier_name" id="supplier_name" placeholder="Supplier Name" pattern="[a-zA-Z][a-zA-Z ]{2,}" title="--Numbers Not Allowed--">
			  </div>
              <div class="form-group">
              ...
              <div class="form-group">
			    ...
			    <input style="font-size:1.4rem;" type="text" class="form-control" name="company" id="company" placeholder="Company Name" pattern="[a-zA-Z][a-zA-Z ]{2,}" title="--Numbers Not Allowed--">
			  </div>
			  <div class="form-group">
        ...
        <br>
			  <button style="margin-left: 23%; font-size: 2rem; width: 54%;" type="submit" name='submit' class="btn btn-default">Create Supplier Account</button>
			<br>
			</br>
			</form>
