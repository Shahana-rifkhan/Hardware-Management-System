...
<div class="head">
          <h1>Sales Report</h1>
          <a style="margin-left:64%; font-size:1.4rem;" href="Reports.php" class="btn">Back</a>
          </div>
<section class="py-5">
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                      ...
                      <div class="card-body">
                          <form action="Sales_PDF.php" method="GET">
                              <div class="row">
                                 <div class="col-md-4"> 
                    ...
                    <div class="card-body">
                        <h6 style="font-size:2rem; font-style:italic;">Sales Report</h6>
                        <hr>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sql = "SELECT * FROM orders JOIN customer ON orders.customer_id=customer.customer_id WHERE orders.order_status = 'Delivered'";
        ...
        <?php
                        ...
                        <div class="card">
                            <div>
                               ...
                               $sql = "SELECT SUM(total_price) AS Total FROM orders WHERE orders.order_status = 'Delivered'";
                               $result = mysqli_query($conn, $sql);
                            ...
                            <a style="font-size:2.2rem;" class="cardName">Total Sales</a>
                            </div>
                            <div class="iconBox">
