...
include_once("Includes/connect.php");
		...
		if(isset($_POST['sub']))
		{
			if(mysqli_query($conn,"UPDATE hr SET password='$_POST[password]' WHERE email='$_POST[email]';"))
			{
...
<!-- Custom StyleSheet -->
<link rel="stylesheet" href="../HR/CSS/Login.css" />
</head>
...
<div class="Logincontainer">
    <form action="" method="POST" class="login-email">
        ...
        <p class="login-register-text">Done Reseting? <a href="HrLogin.php">Login Here</a>.</p>
    </form>
</div>
